...
The public update key is embedded only in the production bundle. The release contains a signed `update-manifest.json`, its detached signature, the archive, and the SHA-256 file. Do not reuse the update-signing private key for any other purpose.
